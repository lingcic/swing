...
public class CounselorEditPanel extends JInternalFrame {
    public CounselorEditPanel(Object id) {
        super("辅导员信息", true, true, true, true);
        ...
        //修改
        if(id != null){
            Object[] user = CounselorDAO.findById(id);
        ...
        btn.addMouseListener(new MouseAdapter(){
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if(id == null){
                    if(CounselorDAO.getUser(field1.getText()) != null){
                        JOptionPane.showMessageDialog(btn.getParent(),"工号已存在","系统提示",JOptionPane.WARNING_MESSAGE);
                        return;
                    }
                    CounselorDAO.add(data);
                }else {
                    CounselorDAO.update(id, data);
                }
                AdminPanel.setContent(new CounselorTablePanel());
            }
        });
        }
    }
