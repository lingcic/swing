...
public class CounselorDataTablePanel extends JInternalFrame {
    ...
    public CounselorDataTablePanel() {
    ...
    private void search(){
        ...
        tableModel = new DefaultTableModel(DataDAO.searchMulti(new int[]{16, 1, 14}, new String[]{user[1].toString(), field1.getText(), "通过"}), DataDAO.columnNames);
